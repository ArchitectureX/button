    ...
    button: {
      ...
      palette: {
        primary: {
          ...
          transparent: 'bg-white hover:bg-elephant text-elephant'
        },
        secondary: {
          ...
          transparent: 'bg-white hover:bg-forest text-forest'
        },
        success: {
          ...
          transparent: 'bg-white hover:bg-emerald text-emerald'
        },
        danger: {
          ...
          transparent: 'bg-white hover:bg-thunderbird text-thunderbird'
        },
        info: {
          ...
          transparent: 'bg-white hover:bg-blue-600 text-blue-600'
        },
        warning: {
          ...
          transparent: 'bg-white hover:bg-fire text-fire'
        },
        light: {
          ...
          transparent: 'bg-white hover:bg-gray-100 text-gray-900'
        },
        dark: {
          ...
          transparent: 'bg-white hover:bg-gray-900 text-gray-100'
        }
      }
    }
  }
